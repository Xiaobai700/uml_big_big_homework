...
!function (a) {
    ...
    return function (a, b) {
        ...
        }, a.config.mapAk = "TVhjYjq1ICT2qqL5LdS8mwas", a.config.uploadImgUrl = "", a.config.uploadTimeout = 2e4, a.config.uploadImgFns = {}, a.config.customUpload = !1, a.config.uploadParams = {}, a.config.uploadHeaders = {}, a.config.hideLinkImg = !1, a.config.pasteFilter = !0, a.config.pasteText = !1
    }), b(function (a, b) {
        a.UI = {}, a.UI.menus = {
            default: {
        ...
        a.createMenu(function (b) {
            ...
            if (b(d)) {
                ...
                m.clickEvent = function (b) {
                    ...
                    h.height(a.$window.height() - n.height() - (m - k)), g.menuContainer.$menuContainer.attr("style", ""),
                        l = !0, g.isFullScreen = !0, c = a.$window.scrollTop()
            ...
            function e() {
                if (!h._disabled && null != g) {
                    ...
                    j = e / 2 - p / 2, m.css({
                        ...
                        left: i,
                        "margin-left": j
                    }), j < 0 ? (m.css("margin-left", "0"), n.hide()) : n.show()
                }
            }
            ...
            function g() {
                if (!k._disabled && null != j) {
                    ...
                    h = e / 2 - m / 2, s.css({
                        ...
                        left: g,
                        "margin-left": h
                    }), h < 0 ? (s.css("margin-left", "0"), t.hide()) : t.show(), k.disableMenusExcept()
                }
            }
