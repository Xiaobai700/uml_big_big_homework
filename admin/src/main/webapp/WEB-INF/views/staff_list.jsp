...
<div class="page-c。ontainer">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l"> <a href="javascript:;" onclick="add_admin('添加管理员','add_admin.html','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span>
...
<script type="text/javascript" src="js/admin/staff_list.js"></script>
